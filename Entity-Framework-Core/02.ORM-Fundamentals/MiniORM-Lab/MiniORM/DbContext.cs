namespace MiniORM
{
    ...
    public abstract class DbContext
    {
        ...
        {
            foreach (var kvp in this.dbSetProperties)
            {
                Type dbSetType = kvp.Key;
                MethodInfo mapRelationsGeneric = typeof(DbContext)
                    .GetMethod("MapRelations", BindingFlags.Instance | BindingFlags.NonPublic)
                    .MakeGenericMethod(dbSetType);
                object dbSet = kvp.Value.GetValue(this);
        ...
        private void InitializeDbSets()
        {
            ...
            {
                Type dbSetType = kvp.Key;
                PropertyInfo dbSetProperty = kvp.Value;
        ...
        private void PopulateDbSet<T>(PropertyInfo dbSet)
            where T : class, new()
        {
            IEnumerable<T> entities = LoadTableEntities<T>();
            DbSet<T> dbSetInstance = new DbSet<T>(entities);
